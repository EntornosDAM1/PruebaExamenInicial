      ...
      <div id="ej2">
        ...
        <Container >
            ...
            <Card.Body>
              ...
              <Card.Subtitle className="mb-2 text-muted">Autor: {this.state.Autor} </Card.Subtitle>
              <Card.Subtitle className="mb-2 text-muted">Fecha de publicación: {this.state.FechaPublicacion} </Card.Subtitle>
              <Card.Subtitle className="mb-2 text-muted">Paginas: {this.state.Paginas} </Card.Subtitle>
              <Card.Subtitle className="mb-2 text-muted">Idioma: {this.state.Idioma} </Card.Subtitle>
